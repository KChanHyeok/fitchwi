        ...
        <Box>
          <Stack flex={2} direction={"row"}>
            ...
            sessionStorage.getItem("id") ? (
              <Button sx={{ fontSize: 20, ml: 60 }}>설정</Button>
            ) : null}
          </Stack>
          <Box sx={{ maxWidth: 900 }}>
          ...
          <Box component="span">
            ...
            1인당 부담금 :{" "}
            {togetherInfo.togetherPrice +
              togetherInfo.togetherOpenedCode.facilitiesCode.facilitiesPrice}
            원 <br />
            모이는 일자 : {togetherInfo.togetherDate}
            <br />
            모집일정 : {togetherInfo.togetherRecruitStartDate} 부터{" "}
            {togetherInfo.togetherRecruitEndDate}까지
            <br />
          ...
          <Box sx={{ mt: 2 }}>
            ...
            sessionStorage.getItem("id") ? (
              ...
              >
                ...
                (data) => data.memberEmail.memberEmail === sessionStorage.getItem("id")
              ).length === 0 ? (
              <TogetherJoin
