...
const FeedGrowth = ({ feedList, memberInfo, refreshFeed }) => {
  const [loading, setLoading] = useState(true);
  const [feedGrowth, setFeedGrowth] = useState();

  useEffect(() => {
    setFeedGrowth(feedList.filter((data) => data.feedCategory === "성장·자기계발"));
    setLoading(false);
  }, [feedList, memberInfo]);
